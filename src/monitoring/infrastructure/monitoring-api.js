...
export class MonitoringApi extends BaseApi {
     ...
     * @returns {Promise<import('axios').AxiosResponse>} Promise resolving to the new equipment's response.
     */
    ...
    /**
     * Deletes a equipment by its ID.
     * @param {int} id - The ID of the equipment to delete.
     */
    deleteEquipment(id) {
        return this.#equipmentsEndpointPath.delete(id);
    }
}
